...
public enum OrderErrorCode implements ErrorCode {
    ...
    INVALID_FILE_EXTENSION("ORDER_400_01", HttpStatus.BAD_REQUEST, "지원하지 않는 파일 형식입니다."),
    INVALID_INGREDIENT("ORDER_400_02", HttpStatus.BAD_REQUEST, "지원하지 않는 재료입니다."),
    ...
    MISSING_QUOTATION_FILE("ORDER_400_05", HttpStatus.BAD_REQUEST, "견적서 최초 작성 시, 견적서 파일은 필수 사항입니다."),
    ...
    MISSING_PURCHASE_ORDER_FILE("ORDER_400_08", HttpStatus.BAD_REQUEST, "발주서 최초 작성 시, 발주서 파일은 필수 사항입니다.");
