...
public interface OrderRepositoryCustom {
    ...
    Page<GetReIssueNewOrderRes> findIsNewAndIsReIssueByFactory(Pageable pageable, Boolean hasQuotation, Boolean isUrgent);

    Page<GetNewIssueNewOrderRes> findIsNewAndIsNewIssueByFactory(Pageable pageable, Boolean hasQuotation, Boolean isNewCustomer, Boolean isUrgent);
