...
public enum UserErrorCode implements ErrorCode {
    ...
    EXPIRED_JWT_TOKEN("USER_401_02", HttpStatus.UNAUTHORIZED, "JWT 토큰 정보가 만료되었습니다."),
    UNSUPPORTED_JWT_TOKEN("USER_401_03", HttpStatus.UNAUTHORIZED, "지원되지 않는 JWT 토큰 입니다."),
    UNAUTHORIZED_JWT_TOKEN("USER_401_04", HttpStatus.UNAUTHORIZED, "JWT 토큰에 권한정보가 존재하지 않습니다."),

    INVALID_ACCESS_JWT_TOKEN("USER_401_05", HttpStatus.UNAUTHORIZED, "Access JWT 토큰 정보가 유효하지 않습니다."),
    INVALID_REFRESH_JWT_TOKEN("USER_401_06", HttpStatus.UNAUTHORIZED, "Refresh JWT 토큰 정보가 유효하지 않습니다."),

    INVALID_VERIFY_CODE("USER_401_07", HttpStatus.UNAUTHORIZED, "인증 코드 정보가 유효하지 않습니다."),

    INVALID_CHANGE_PASSWORD_JWT_TOKEN("USER_401_08", HttpStatus.UNAUTHORIZED, "Change Password JWT 토큰 정보가 유효하지 않습니다."),
